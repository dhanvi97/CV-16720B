...
def evaluate_recognition_system(num_workers=4):
    ...
    * accuracy: accuracy of the evaluated system
    ...
    gnb = GaussianNB()
    model = gnb.fit(trained_features, train_labels)
    ...
    ordered_labels = model.predict(output)
...
# print(get_num_CPU())
conf_matrix, accuracy = evaluate_recognition_system(get_num_CPU())
